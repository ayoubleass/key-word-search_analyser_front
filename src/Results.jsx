...
const ActionButtons = ({ isLoading , onDownload, onSave, disabled }) => (
...
export default function Results() {
  ...
  const { setProject, project , setResults, results,setAiResponse ,save ,setSave} = useMainContext(); 
